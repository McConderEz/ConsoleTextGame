...
{
    internal class PoisoningEffect : BaseEffect //TODO:Добавить эффект к какому-нибудь классу и протестироват его(отравление)
    {
        ...
        public void Poisoning(Hero unit)
        {
            ...
            unit.Hp -= unit.CalcMagicDMG(unit, (int)((double)EffectStrength * 0.35));
            Console.WriteLine($"{this.Name} -{unit.CalcMagicDMG(unit, (int)((double)EffectStrength * 0.35))} Хп {this.Duration} Ход", Console.ForegroundColor = ConsoleColor.DarkGreen);
